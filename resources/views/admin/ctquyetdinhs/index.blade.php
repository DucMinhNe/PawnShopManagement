...
$(function() {
    ...
    $('#createNewBtn').click(function() {
        ...
        $('#id').val('');
        $('#id_quyet_dinh').val('').trigger('change');
        $('#ma_sv_nhan_quyet_dinh').val('').trigger('change');
    ...
    $('body').on('click', '.editBtn', function() {
        ...
        $.get("{{ route('ctquyetdinh.index') }}" + '/' + id + '/edit', function(data) {
            ...
            $('#ajaxModelexa').modal('show');
            $('#id').val(data.id);
            $('#id_quyet_dinh').val(data.id_quyet_dinh).trigger('change');
            $('#ma_sv_nhan_quyet_dinh').val(data.ma_sv_nhan_quyet_dinh).trigger('change');
